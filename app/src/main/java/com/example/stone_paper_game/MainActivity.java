package com.example.stone_paper_game;
...
import com.example.stone_paper_game.databinding.ActivityMainBinding;
...
Dialog dialog;
    ...
    private void showlossdialog() {
        dialog.setContentView(R.layout.loss_dilog);
    ...
    private void showwindialog() {
        dialog.setContentView(R.layout.win_dilog);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        ImageView close=dialog.findViewById(R.id.close);
        dialog.show();
        close.setOnClickListener(new View.OnClickListener() {
    ...
    private void showtiedialog() {
        dialog.setContentView(R.layout.tie_dilog);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        ImageView close=dialog.findViewById(R.id.close);
        dialog.show();
        close.setOnClickListener(new View.OnClickListener() {
